...
- Create Angular project with ng: `ng new video-game-catalogue-aspnet-angular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`video-game-catalogue-aspnet-angular.client.esproj`).
